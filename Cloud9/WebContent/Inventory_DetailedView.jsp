...
<!-- <iframe width="933" height="700" src="https://app.powerbi.com/view?r=eyJrIjoiYWQ3YjQ2YmQtMDk4Ny00ODE2LWIwZGMtM2FhYWU5NTc3MDZiIiwidCI6IjQ0ZTNjZjk0LTE5YzktNGUzMi05NmMzLTE0ZjViZjAxMzkxYSIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe> -->
<!-- Fontfaces CSS-->
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<%
											...
											String myArr[] = ItemDao.findLabelType(I.getQuantity());
										%>
										<div class="row">
											<div class="col-lg-6">
												<div class="card">
												...
												<div class="card">
													...
													<div class="card-body">
														...
														<div class="typo-articles">
															<h4 class="pb-2 display-5 ">Description</h4>
															<p class="mb-3"><%=I.getDescription()%></p>
															<h4 class="pb-2 display-5">Quantity</h4>

															<p class="mb-3"><%=I.getQuantity()%></p>
															<p>
																<span class="badge badge-<%=myArr[0]%>"><%=myArr[1]%></span>
															</p>
															<div class="row">
																<div class=container>
																	<div class="btn-toolbar mb-3">

																		<form action="RestockItems" method="get">
																			<span>
																				...
																				placeholder="Amount" class="border border-dark">

																			</span>
																		</form>

																		<form action="ConsumeItem" method="get">
																			<span>

																				<button type="submit"
																					class="btn btn-outline-danger btn-sm">
																					<i class="fa fa-minus"></i>&nbsp; Consume
																				</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
																				type="text" name="amount2" placeholder="Amount"
														...
														<h4 class="pb-2 display-5">Supplier</h4>
														<p class="mb-3"><%=I.getSupplier()%></p>
														<h4 class="pb-2 display-5">Price</h4>
														<p class="mb-3"><%=I.getPrice()%></p>
														...
														</a> <a href="Inventory_EditView.jsp">
