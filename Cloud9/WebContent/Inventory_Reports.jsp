			...
			<div class="header-mobile__bar">
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <img src="images/icon/RSTLogo.png" alt="CoolAdmin" />
						</a>
			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li  class="active has-sub"><a href="chart.html"> <i class="fas fa-chart-bar"></i>Reports
						</a></li>
						
						<li><a href="Inventory_Add.jsp"> <i class="far fa-plus-square"></i>Add Items
						</a></li>
								...
								<div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Realtime Reports</h3>
                                        </div>
                                        <hr>
