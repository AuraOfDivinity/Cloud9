			...
			<div class="header-mobile__bar">
				<div class="container-fluid">
					<div class="header-mobile-inner">
						<a class="logo" href="index.html"> <img src="images/icon/RSTLogo.png"/>
						</a>
			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="active has-sub"><a href="Inventory_ViewAll.jsp">
							...
							<div class="col-md-12">
								...
								<div class="card">
									<div class="card-header">
										<strong class="card-title">Recent Items</strong>
									</div>
									<div class="row">
										<div class="col-md-12">
											<!-- DATA TABLE -->
												...
												<table class="table table-data2">
													...
													<tbody>
														...
														<tr class="tr-shadow">
															...
															<td><%=I.getID()%></td>
															<td><span class="block-email"><%=I.getName()%></span></td>
															...
															<td>
																<div class="table-data-feature">
																	<a href="KeyServlet?param2=<%=I.getID()%>">
																	...
																	<a href="DeleteItem?param1=<%=I.getName()%>">
																		<button class="item" data-toggle="tooltip"
